...
import { SymbolSelector } from '@/components/crypto/SymbolSelector';
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Symbol selection + Filter Toggle */}
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="inline-flex rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 p-1">
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium rounded-md transition-colors flex items-center gap-1 ${filter === 'watchlist'
                    ? 'bg-primary text-white'
                    : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'
                  }`}
              >
